...
- **光锥音乐** — 界面设计与功能实现参考。
- 感谢 Ella Music 所使用的 Miuix、Media3、FFmpeg、Lyricon、SuperLyricApi、LyricGetter-API、lyrico-audiotag / Lyrico、TagLib、163KeyDecrypter、Kyant Backdrop、Coil、OkHttp、accompanist-lyrics-core 以及其它开源项目。
